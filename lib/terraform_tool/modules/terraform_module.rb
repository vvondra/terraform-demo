...
require 'terraform_tool/helpers/string_helpers'
require 'hcl/checker'
require 'yaml'
...
module TerraformTool
  module Modules
    class TerraformModule
      ...
      extend TerraformTool::Helpers::PathHelpers
      include TerraformTool::Helpers::StringHelpers
      ...
      def run_hooks
        ...
        hooks_module = "TerraformTool::Modules::#{camel_case(@name)}::Hooks"
      ...
      def validate
        if data? && File.file?(validator_file)
          ...
          begin
            validator_class = "TerraformTool::Validators::#{camel_case(@name)}Validator"
          ...
          rescue TerraformTool::Validators::ValidationError => validation_error
      ...
      def template_binding(data)
        binding = TerraformTool::Templates::TemplateBinding.new(
          context: @context,
          environment: @environment,
          module_name: @name,
          data: data,
